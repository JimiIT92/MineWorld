...
/**
 * Implementation class for a Witch Hat item
 */
public class WitchHatItem extends MWHatItem {
     ...
     */
    public WitchHatItem() {
        super(MWArmorMaterials.WITCH, PropertyHelper.basicItemProperties().rarity(Rarity.UNCOMMON));
    }
    ...
    /**
     * The Witch Hat {@link IClientItemExtensions armor renderer} implementation
     */
    private static final class ArmorRender implements IClientItemExtensions {
        ...
        public @NotNull HumanoidModel<?> getHumanoidArmorModel(final LivingEntity living, final ItemStack stack, final EquipmentSlot slot, final HumanoidModel<?> model) {
            ...
            final ModelPart root = models.bakeLayer(WitchHatModel.LAYER_LOCATION);
            return new WitchHatModel(root);
        }
    }
