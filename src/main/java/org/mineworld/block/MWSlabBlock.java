...
/**
 * {@link MineWorld MineWorld} {@link SlabBlock Slab Block}
 */
public class MWSlabBlock extends SlabBlock {

    /**
     * {@link Supplier<BlockState> The Slab Block State Supplier}
     */
     ...
     * @return {@link PushReaction The appropriate Push Reaction based on the Slab material}
     */
    ...
    /**
     * Determine if the {@link SlabBlock Slab Block} is flammable
     *
     * @param blockState {@link BlockState The current Block State}
