 ...
 */
public class MWWeatheringCopperStairBlock extends StairBlock implements IMWWeatheringBlock, IMWWaxableBlock {
     ...
     */
    public MWWeatheringCopperStairBlock(final WeatheringCopper.WeatherState weatherState, final BlockState blockState, final FeatureFlag... featureFlags) {
        super(blockState, PropertyHelper.copyFromBlock(blockState.getBlock(), featureFlags));
