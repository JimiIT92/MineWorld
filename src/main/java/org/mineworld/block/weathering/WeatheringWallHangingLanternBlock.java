...
/**
 * {@link MineWorld MineWorld} {@link IMWWeatheringBlock Weathering} {@link WallHangingLanternBlock Wall Hanging Lantern Block}
 */
public class WeatheringWallHangingLanternBlock extends WallHangingLanternBlock implements IMWWeatheringBlock, IMWWaxableBlock {

    /**
     * {@link WeatheringCopper.WeatherState The Wall Hanging Lantern Weather State}
     */
     ...
     */
    public WeatheringWallHangingLanternBlock(final WeatheringCopper.WeatherState weatherState, final Supplier<BlockState> blockStateSupplier, final FeatureFlag... featureFlags) {
        super(PropertyHelper.copy(blockStateSupplier.get().getBlock(), featureFlags));
