 ...
 */
public class WeatheringCopperCageBlock extends Block implements IMWWeatheringBlock {
     ...
     */
    public WeatheringCopperCageBlock(final WeatheringCopper.WeatherState weatherState, final boolean isWaxed) {
        super(MWBlocks.translucentProperties(MWBlocks.copyFrom(Blocks.COPPER_BLOCK)));
