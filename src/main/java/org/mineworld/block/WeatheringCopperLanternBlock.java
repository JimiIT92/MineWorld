...
/**
 * Implementation class for a {@link ChangeOverTimeBlock weathering lantern}
 */
public class WeatheringCopperLanternBlock extends LanternBlock implements IMWWeatheringBlock {
     ...
     */
    public WeatheringCopperLanternBlock(final WeatheringCopper.WeatherState weatherState, final int lightLevel, final boolean isWaxed) {
        super(MWBlocks.copyFrom(Blocks.LANTERN).lightLevel(state -> lightLevel));
