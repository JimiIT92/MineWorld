 ...
 */
public class WeatheringCopperChainBlock extends ChainBlock implements IMWWeatheringBlock {
     ...
     */
    public WeatheringCopperChainBlock(final WeatheringCopper.WeatherState weatherState, final boolean isWaxed) {
        super(MWBlocks.copyFrom(Blocks.CHAIN));
