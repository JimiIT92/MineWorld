 ...
 */
public class WaxedWeatheringCopperChainBlock extends ChainBlock implements IMWWeatheringBlock {
     ...
     */
    public WaxedWeatheringCopperChainBlock(final WeatheringCopper.WeatherState weatherState) {
