...
/**
 * {@link ChestRenderer Renderer} class for a bamboo trapped chest
 */
@OnlyIn(Dist.CLIENT)
public class BambooTrappedChestRenderer extends BambooChestRenderer {
     ...
     */
    public BambooTrappedChestRenderer(final BlockEntityRendererProvider.Context context) {
        super(context);
    }
