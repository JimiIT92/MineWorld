...
/**
 * {@link ChestRenderer Renderer} class for a jungle chest
 */
@OnlyIn(Dist.CLIENT)
public class JungleChestRenderer extends AbstractChestRenderer {
     ...
     */
    public JungleChestRenderer(final BlockEntityRendererProvider.Context context) {
        super(context);
    }
     ...
     *
     * @return {@link WoodType#JUNGLE Jungle wood type}
     */
    @Override
