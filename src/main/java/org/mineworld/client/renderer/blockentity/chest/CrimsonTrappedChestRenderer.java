...
/**
 * {@link ChestRenderer Renderer} class for a crimson trapped chest
 */
@OnlyIn(Dist.CLIENT)
public class CrimsonTrappedChestRenderer extends CrimsonChestRenderer {
     ...
     */
    public CrimsonTrappedChestRenderer(final BlockEntityRendererProvider.Context context) {
        super(context);
    }
