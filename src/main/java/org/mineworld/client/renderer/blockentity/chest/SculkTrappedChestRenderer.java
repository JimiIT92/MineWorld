...
/**
 * {@link ChestRenderer Renderer} class for a sculk trapped chest
 */
@OnlyIn(Dist.CLIENT)
public class SculkTrappedChestRenderer extends SculkChestRenderer {
     ...
     */
    public SculkTrappedChestRenderer(final BlockEntityRendererProvider.Context context) {
        super(context);
    }
