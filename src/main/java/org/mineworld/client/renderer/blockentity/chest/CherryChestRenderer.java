...
/**
 * {@link ChestRenderer Renderer} class for a cherry chest
 */
@OnlyIn(Dist.CLIENT)
public class CherryChestRenderer extends AbstractChestRenderer {
     ...
     */
    public CherryChestRenderer(final BlockEntityRendererProvider.Context context) {
        super(context);
    }
     ...
     *
     * @return {@link WoodType#CHERRY Cherry wood type}
     */
    @Override
