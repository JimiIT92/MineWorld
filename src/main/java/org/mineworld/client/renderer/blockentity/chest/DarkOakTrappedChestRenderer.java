...
/**
 * {@link ChestRenderer Renderer} class for a dark oak trapped chest
 */
@OnlyIn(Dist.CLIENT)
public class DarkOakTrappedChestRenderer extends DarkOakChestRenderer {
     ...
     */
    public DarkOakTrappedChestRenderer(final BlockEntityRendererProvider.Context context) {
        super(context);
    }
