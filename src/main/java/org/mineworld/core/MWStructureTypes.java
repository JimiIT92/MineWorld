...
import org.mineworld.world.structure.EtherealRuin;
...
public final class MWStructureTypes {
    ...
    public static final RegistryObject<StructureType<EtherealRuin>> RUINED_ETHEREAL_PORTAL = registerStructureType("ruined_ethereal_portal");
     ...
     */
    private static <T extends MWJigsawStructure> RegistryObject<StructureType<T>> registerStructureType(final String name) {
        return STRUCTURE_TYPES.register(name, () -> () -> (Codec<T>) MWJigsawStructure.CODEC);
    }
