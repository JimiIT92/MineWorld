...
public final class MWFlowerPots {
    ...
    public static final RegistryObject<Block> POTTED_OAK_LEAVES = registerFlowerPot("oak_leaves", Suppliers.memoize(() -> Blocks.OAK_LEAVES));
    public static final RegistryObject<Block> POTTED_SPRUCE_LEAVES = registerFlowerPot("spruce_leaves", Suppliers.memoize(() -> Blocks.SPRUCE_LEAVES));
    public static final RegistryObject<Block> POTTED_BIRCH_LEAVES = registerFlowerPot("birch_leaves", Suppliers.memoize(() -> Blocks.BIRCH_LEAVES));
    public static final RegistryObject<Block> POTTED_JUNGLE_LEAVES = registerFlowerPot("jungle_leaves", Suppliers.memoize(() -> Blocks.JUNGLE_LEAVES));
    public static final RegistryObject<Block> POTTED_ACACIA_LEAVES = registerFlowerPot("acacia_leaves", Suppliers.memoize(() -> Blocks.ACACIA_LEAVES));
    public static final RegistryObject<Block> POTTED_CHERRY_LEAVES = registerFlowerPot("cherry_leaves", Suppliers.memoize(() -> Blocks.CHERRY_LEAVES));
    public static final RegistryObject<Block> POTTED_DARK_OAK_LEAVES = registerFlowerPot("dark_oak_leaves", Suppliers.memoize(() -> Blocks.DARK_OAK_LEAVES));
    public static final RegistryObject<Block> POTTED_MANGROVE_LEAVES = registerFlowerPot("mangrove_leaves", Suppliers.memoize(() -> Blocks.MANGROVE_LEAVES));
    ...
    public static final RegistryObject<Block> POTTED_MANGROVE_ROOTS = registerFlowerPot("mangrove_roots", Suppliers.memoize(() -> Blocks.MANGROVE_ROOTS));
    ...
    public static final RegistryObject<Block> POTTED_BAMBOO_BLOCK = registerFlowerPot("bamboo_block", Suppliers.memoize(() -> Blocks.BAMBOO_BLOCK));
    public static final RegistryObject<Block> POTTED_STRIPPED_BAMBOO_BLOCK = registerFlowerPot("stripped_bamboo_block", Suppliers.memoize(() -> Blocks.STRIPPED_BAMBOO_BLOCK));
    ...
    public static final RegistryObject<Block> POTTED_OAK_BUSH = registerFlowerPot("oak_bush", Suppliers.memoize(() -> MWBlocks.OAK_BUSH.get()));
    public static final RegistryObject<Block> POTTED_SPRUCE_BUSH = registerFlowerPot("spruce_bush", Suppliers.memoize(() -> MWBlocks.SPRUCE_BUSH.get()));
    public static final RegistryObject<Block> POTTED_BIRCH_BUSH = registerFlowerPot("birch_bush", Suppliers.memoize(() -> MWBlocks.BIRCH_BUSH.get()));
    public static final RegistryObject<Block> POTTED_JUNGLE_BUSH = registerFlowerPot("jungle_bush", Suppliers.memoize(() -> MWBlocks.JUNGLE_BUSH.get()));
    public static final RegistryObject<Block> POTTED_ACACIA_BUSH = registerFlowerPot("acacia_bush", Suppliers.memoize(() -> MWBlocks.ACACIA_BUSH.get()));
    public static final RegistryObject<Block> POTTED_DARK_OAK_BUSH = registerFlowerPot("dark_oak_bush", Suppliers.memoize(() -> MWBlocks.DARK_OAK_BUSH.get()));
    public static final RegistryObject<Block> POTTED_MANGROVE_BUSH = registerFlowerPot("mangrove_bush", Suppliers.memoize(() -> MWBlocks.MANGROVE_BUSH.get()));
    public static final RegistryObject<Block> POTTED_CHERRY_BUSH = registerFlowerPot("cherry_bush", Suppliers.memoize(() -> MWBlocks.CHERRY_BUSH.get()));
    public static final RegistryObject<Block> POTTED_APPLE_SAPLING = registerFlowerPot("apple_sapling", Suppliers.memoize(() -> MWBlocks.APPLE_SAPLING.get()));
    public static final RegistryObject<Block> POTTED_APPLE_LEAVES = registerFlowerPot("apple_leaves", Suppliers.memoize(() -> MWBlocks.APPLE_LEAVES.get()));
