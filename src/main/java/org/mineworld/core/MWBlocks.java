...
public final class MWBlocks {
    ...
    public static final RegistryObject<Block> CHISELED_STONE_BRICKS_STAIRS = RegisterHelper.registerStair("chiseled_stone_bricks_stairs", Blocks.CHISELED_STONE_BRICKS::defaultBlockState);
    public static final RegistryObject<Block> CHISELED_STONE_BRICKS_SLAB = RegisterHelper.registerSlab("chiseled_stone_bricks_slab", () -> Blocks.CHISELED_STONE_BRICKS);
    public static final RegistryObject<Block> CHISELED_STONE_BRICKS_WALL = RegisterHelper.registerWall("chiseled_stone_bricks_wall", () -> Blocks.CHISELED_STONE_BRICKS);
    public static final RegistryObject<Block> CHISELED_STONE_BRICKS_PRESSURE_PLATE = RegisterHelper.registerPressurePlate("chiseled_stone_bricks_pressure_plate", false, MaterialColor.STONE, BlockSetType.STONE);
    public static final RegistryObject<Block> CHISELED_STONE_BRICKS_BUTTON = RegisterHelper.registerButton("chiseled_stone_bricks_button", false, BlockSetType.STONE);
    public static final RegistryObject<Block> CHISELED_STONE_BRICKS_PEBBLE = RegisterHelper.registerPebble("chiseled_stone_bricks_pebble", () -> Blocks.CHISELED_STONE_BRICKS);
    ...
    public static final RegistryObject<Block> MOSSY_CHISELED_STONE_BRICKS_STAIRS = RegisterHelper.registerStair("mossy_chiseled_stone_bricks_stairs", () -> MOSSY_CHISELED_STONE_BRICKS.get().defaultBlockState());
    public static final RegistryObject<Block> MOSSY_CHISELED_STONE_BRICKS_SLAB = RegisterHelper.registerSlab("mossy_chiseled_stone_bricks_slab", MOSSY_CHISELED_STONE_BRICKS);
    public static final RegistryObject<Block> MOSSY_CHISELED_STONE_BRICKS_WALL = RegisterHelper.registerWall("mossy_chiseled_stone_bricks_wall", MOSSY_CHISELED_STONE_BRICKS);
    public static final RegistryObject<Block> MOSSY_CHISELED_STONE_BRICKS_PRESSURE_PLATE = RegisterHelper.registerPressurePlate("mossy_chiseled_stone_bricks_pressure_plate", false, MaterialColor.STONE, BlockSetType.STONE);
    public static final RegistryObject<Block> MOSSY_CHISELED_STONE_BRICKS_BUTTON = RegisterHelper.registerButton("mossy_chiseled_stone_bricks_button", false, BlockSetType.STONE);
    public static final RegistryObject<Block> MOSSY_CHISELED_STONE_BRICKS_PEBBLE = RegisterHelper.registerPebble("mossy_chiseled_stone_bricks_pebble", MOSSY_CHISELED_STONE_BRICKS);
