...
public final class MWTabs {
    ...
    private static void setBuildingBlocksTab(final CreativeModeTabEvent.BuildContents event) {
        addToTab(event,
                ...
                MWBlocks.CHISELED_STONE_BRICKS_STAIRS,
                MWBlocks.CHISELED_STONE_BRICKS_SLAB,
                MWBlocks.CHISELED_STONE_BRICKS_WALL,
                MWBlocks.CHISELED_STONE_BRICKS_PRESSURE_PLATE,
                MWBlocks.CHISELED_STONE_BRICKS_BUTTON,
                MWBlocks.MOSSY_STONE_BRICKS_PRESSURE_PLATE,
                MWBlocks.MOSSY_STONE_BRICKS_BUTTON,
                MWBlocks.MOSSY_CHISELED_STONE_BRICKS,
                MWBlocks.MOSSY_CHISELED_STONE_BRICKS_STAIRS,
                MWBlocks.MOSSY_CHISELED_STONE_BRICKS_SLAB,
                MWBlocks.MOSSY_CHISELED_STONE_BRICKS_WALL,
                MWBlocks.MOSSY_CHISELED_STONE_BRICKS_PRESSURE_PLATE,
                MWBlocks.MOSSY_CHISELED_STONE_BRICKS_BUTTON,
    ...
    private static void setFunctionalBlocksTab(final CreativeModeTabEvent.BuildContents event) {
        addToTab(event,
                ...
                MWItems.CHISELED_STONE_BRICKS_PEBBLE,
                MWItems.MOSSY_STONE_BRICKS_PEBBLE,
                MWItems.MOSSY_CHISELED_STONE_BRICKS_PEBBLE,
